...
class Controller {
  ...
  find(req, res, next) {
    ...
    return this.facade.paginatedFind(page, limit, removePaginationInfo(req).query, this.findOptions)
  ...
  findOne(req, res, next) {
    ...
    return this.facade.findOne(req.query, this.findOptions)
  ...
  findById(req, res, next) {
    ...
    return this.facade.findById(req.params.id, this.findOptions)
      .then((doc) => {
